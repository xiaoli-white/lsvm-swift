public final class Interpreter {
    ...
    public func evalFrame(_ frame: Object.FrameObject) {
        ...
        loop: while true {
            ...
            case .RETURN_CONSTANT:
                ...
                let constant = currentFrame!.code.constants[
                    Object.IntegerObject(value: Int64(arg))]!
                currentFrame = currentFrame!.parent
                push(constant)
            case .RETURN_NULL:
                if currentFrame!.parent == nil {
    ...
    public func stackDepth() -> UInt64 {
        ...
        return UInt64(
            (stackAddr - baseAddr)
                / UInt64(MemoryLayout<UnsafeMutablePointer<Object.BaseObject>>.size))
    }
